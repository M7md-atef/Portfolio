        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="glass-card rounded-2xl p-6 sm:p-7 space-y-6 border border-slate-200/80 dark:border-slate-800/80 flex-1 flex flex-col justify-between">
              ...
              <div className="space-y-4">
                ...
                <a
                  ...
                  className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 hover:bg-cyan-50 dark:hover:bg-slate-800 border border-slate-200/80 dark:border-slate-700/60 hover:border-cyan-400/50 transition-all duration-200 group"
                >
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="glass-card rounded-2xl p-6 sm:p-8 border border-slate-200/80 dark:border-slate-800/80 flex-1 flex flex-col">
              ...
              {status.submitted && (
                <div className="mb-6 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 flex items-start gap-3 animate-fadeIn">
              ...
              {status.error && (
                <div className="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/30 text-red-600 dark:text-red-400 flex items-center gap-3">
